...
public class SavingAccountModel extends BankAccountModel{
    //atributos
    ...
    public SavingAccountModel(String nameCustomer, String bankAccount, double balance, double rateInterest, double maintenanceAccount){
