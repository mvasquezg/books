...
class SavingBank{
    ...
    public static void Main(string[] args){
        ...
        System.Console.Write("Ingrese la cantidad a invertir: ");
        capital=int.Parse(System.Console.ReadLine());

        System.Console.Write("Ingrese el interes: ");
        interest=float.Parse(System.Console.ReadLine());;

        System.Console.Write("Ingrese el numero de semanas: ");
        numberOfWeeks=int.Parse(System.Console.ReadLine());;
