...
class AverageSpeed{
    public static void Main(string[] args){
        ...
        System.Console.Write("Captura el tiempo de los corredores (minutos, segundos).\nPara terminar la captura ingresa (0,0).\n");
        do{
            System.Console.Write("\ningresa minutos: ");
            min=int.Parse(System.Console.ReadLine());

            System.Console.Write("ingresa segundos: ");
            sec=int.Parse(System.Console.ReadLine());
