...
void main(){
    ...
    printf("Programa que realiza una estadística de los pesos de los alumnos de un colegio de acuerdo a la siguiente tabla:");
    printf("\n\nAlumnos de menos de 40 kg.\nAlumnos entre 40 y 50 kg.\nAlumnos de más de 50 kg y menos de 60 kg.\nAlumnos de más o igual a 60 kg.\n");
    ...
    printf("\nAlumnos con peso menos de 40 kG: %d", weigth1);
    printf("\nAlumnos con peso de 40 kG-50KG: %d", weigth2);
    printf("\nAlumnos con peso mayor de 50 kG y menos de 60 KG: %d", weigth3);
    printf("\nAlumnos con peso igual o mayor a 60: %d\n", weigth4);
}