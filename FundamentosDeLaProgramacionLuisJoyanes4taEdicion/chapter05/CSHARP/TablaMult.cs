        ...
        for(int i=1; i<=x; i++){
            for(int j=1; j<=y; j++){
               producto=i*j;
                ...
                System.Console.Write(string.Format("{0, 2}",i)+string.Format("{0, 2}","x")+string.Format("{0, 2}",j)+string.Format("{0, 2}","=")+string.Format("{0, 2}",producto)+"\n"); 
               //System.Console.Write(i<<"x"<<j<<"="<<producto<<"\n"); 
            }
