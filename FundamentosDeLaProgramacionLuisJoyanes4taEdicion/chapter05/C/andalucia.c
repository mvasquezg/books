...
void main(){
    ...
    for(int i=1; i<=8; i++){
        ...
        for(int j=1; j<=25; j++){
            ...
            printf("Ingrese la cantidad de poblacion de la provincia %d: ", j);
            scanf("%d", &pob);
        ...
        printf("\nEn la ciudad %d, la provincia %d es la mayor con un poblacion de %d habitantes\n", i, mayorCity, mayorTown);
        mayorCity=0;
        mayorTown=0;    
    }//end for i
    printf("\n\n"); 
